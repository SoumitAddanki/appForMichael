...
function DashboardPage() {
    ...
    const openEditModal = async (video)=>{
        ...
        // load its tags
        const { data: tagData } = await supabase.from('tags').select('tag').eq('videoId', video.id);
        setTags(tagData?.map((t)=>t.tag) || []);
        // load its sections
        const { data: rels } = await supabase.from('section_videos').select('section_id').eq('video_id', video.id);
    ...
    const toggleSection = (id)=>{
        setSelectedSections((prev)=>prev.includes(id) ? prev.filter((x)=>x !== id) : [
                ...prev,
                id
            ]);
    };
    // submit handlers
    const handleSubmit = (e)=>editingVideo ? updateVideo(e) : addVideo(e);
    ...
    const updateVideo = async (e)=>{
        ...
        }).eq('id', editingVideo.id).select().single();
        if (error) {
    ...
    const syncTagsAndSections = async (videoId)=>{
        // tags
        await supabase.from('tags').delete().eq('videoId', videoId);
        if (tags.length) {
            await supabase.from('tags').insert(tags.map((tag)=>({
                    videoId,
                    tag
                })));
        }
        ...
        if (selectedSections.length) {
            await supabase.from('section_videos').insert(selectedSections.map((sid)=>({
                    video_id: sid,
                    section_id: sid
                })));
        }
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                    children: loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                        ...
                                        lineNumber: 274,
                                        columnNumber: 17
                                    }, this) : videos.map((v)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: sections.map((sec)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                    ...
                                                    disabled: isSaving,
                                                    children: isSaving ? 'Saving...' : editingVideo ? 'Save' : 'Add Video'
                                                }, void 0, false, {
                                                    fileName: "[project]/app/page.tsx",
                                                    lineNumber: 467,
                                                    columnNumber: 19
...
_s(DashboardPage, "PybTXkNHZy9HXF35NhBwedUNf40=");
_c = DashboardPage;
var _c;
